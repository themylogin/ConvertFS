...
${OBJECTDIR}/ExtensionClassificator.o: ExtensionClassificator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ExtensionClassificator.o ExtensionClassificator.cpp

${OBJECTDIR}/Entry.o: Entry.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Entry.o Entry.cpp

${OBJECTDIR}/RegularFileStreamFactory.o: RegularFileStreamFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RegularFileStreamFactory.o RegularFileStreamFactory.cpp
...
${OBJECTDIR}/RegularFileStream.o: RegularFileStream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RegularFileStream.o RegularFileStream.cpp

${OBJECTDIR}/ShellCommandStreamFactory.o: ShellCommandStreamFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShellCommandStreamFactory.o ShellCommandStreamFactory.cpp
...
${OBJECTDIR}/WindowsNamesFilter.o: WindowsNamesFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/WindowsNamesFilter.o WindowsNamesFilter.cpp
...
${OBJECTDIR}/AnyClassificator.o: AnyClassificator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AnyClassificator.o AnyClassificator.cpp

${OBJECTDIR}/ConvertFilter.o: ConvertFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConvertFilter.o ConvertFilter.cpp
...
${OBJECTDIR}/IgnoreFilter.o: IgnoreFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/IgnoreFilter.o IgnoreFilter.cpp
